<?php
/**
 * PlayTube to YouTube Converter
 * Extracts YouTube URLs from PlayTube redirect links.
 */
?>
<!DOCTYPE html>
...
<head>
  ...
  <meta name="description" content="Convert PlayTube redirect URLs back to original YouTube links">
  <title>PlayTube to YouTube Converter</title>
...
<body>
  ...
  <main>
    <section class="hero compact">
      ...
      <p>Paste PlayTube redirect URLs to extract the original YouTube links. Supports multiple URLs at once.</p>
    </section>
    ...
    <section class="converter-section">
      <div class="converter-card">
        <textarea
          ...
          placeholder="Paste PlayTube URL(s) here, one per line..."
        ></textarea>
  ...
  <footer>
    <p>&copy; <?php echo date('Y'); ?> Link Converter. Extract YouTube links from PlayTube redirects.</p>
  </footer>
      ...
      function convertLinks() {
        ...
        for (const line of lines) {
          ...
          try {
            ...
            if (link) {
              const youtube = decodeURIComponent(link);
              results.push(
              ...
              results.push('<div class="msg-error">Invalid PlayTube URL:<br>' + line + '</div>');
            }
          } catch (e) {
            results.push('<div class="msg-error">Invalid URL:<br>' + line + '</div>');
          }
        }
